...
export default class CardController {
  constructor(cardUi) {
    this.cardUi = cardUi;
    this.paymentSystem = new PaymentSystem(this.cardUi.cardsMap);
  ...
  init() {
    ...
    this.cardUi.inputEl.addEventListener('input', () => {
      ...
      this.cardUi.cardsMap.forEach((card) => {
    ...
    this.cardUi.btnEl.addEventListener('click', (event) => {
      ...
      if (this.match.length) {
        ...
        cardTitleEl.innerHTML = 'Невозможно определить платежную систему';
      }
